...
// //       console.log("Initialize platform automation", this.platformAutomation)
...
class ContentScriptManager {
  ...
  async startAutomationIfReady() {
    // Wait a bit for background script to send start message
    // If no message comes, try to auto-start with basic config
    setTimeout(async () => {
    ...
    }, 5000); // Wait 5 seconds for background message
  }
